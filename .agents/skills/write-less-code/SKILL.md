...
- Do not remove Modulith boundaries or MCP degradation logic for "simplicity"
- Do not strip tests to reduce line count
- Prefer extending med-expert-match-ce patterns over new abstractions
