...
General-purpose AI chat: multi-session history, SSE streaming, Harness progress, optional MCP enrichment. **M5 implemented** — Harness workflow engine, activity SSE. Next: M6 per [docs/01-requirements.md](docs/01-requirements.md).
